...
ATS_MAINATSFLAG 1
#define
ATS_DYNLOADNAME "libxargsof_dynloadall"
#endif // #ifdef
...
if
(argc >= 2)
then argsof0_main0(argc, argv)
else prerrln! ("Hello from ATS3(xargsof)!")
// end of [if]
) (* end of [main] *)
#endif // ifdef(_LIBXARGSOF_)
//
(* ****** ****** *)
