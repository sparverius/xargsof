...
implement{} argsof_t3imp(x0) = tlist1(x0)
implement{} argsof_ti3err(x0) = tlist1(x0)
...
implement{} argsof_t2pcast(x0) = tlist1(x0)
implement{} argsof_d3valdecl(x0) = tlist1(x0)
implement{} argsof_d3vardecl(x0) = tlist1(x0)
implement{} argsof_d3fundecl(x0) = tlist1(x0)
...
//implement{} argsof_f3arglstopt(x) = tlist1(x)
implement{} argsof_d3gualst(x) = tlist1(x)
implement{} argsof_d3valdeclist(x) = tlist1(x)
implement{} argsof_d3vardeclist(x) = tlist1(x)
implement{} argsof_d3fundeclist(x) = tlist1(x)
...
| D3Pc00(x) => tlist1(x)
| D3Ps00(x) => tlist1(x)
| D3Psap0(x, y) => tlist2(x, y)
| D3Psap1(x, y) => tlist2(x, y)
| D3Pdap1(x) => tlist1(x)
| D3Pnil() => tlist0()
| D3Pany() => tlist0()
...
| D3Ptrcd1(knd1, npf2, ldps) => tlist3(knd1, npf2, ldps)
| D3Panno(d3p1, s2e2, t3) => tlist3(d3p1, s2e2, t3)
...
| D3Ei00(tok) => tlist1(tok)
| D3Eb00(tok) => tlist1(tok)
| D3Ec00(tok) => tlist1(tok)
| D3Es00(tok) => tlist1(tok)
| D3Ekvar(t0, t1) => tlist2(t0, t1)
| D3Eterr(t0, t1, t2) =>
  tlist3(
    t0,
    "ERROR: ti3err NOT IMPLEMENTED YET",
    "ERROR: t3imp NOT IMPLEMENTED YET!"
  )
| D3Epbox(t0, t1, t2) => tlist3(t0, t1, t2)
| D3Eplft(t0, t1, t2) => tlist3(t0, t1, t2)
| D3Epptr(t0, t1, t2) => tlist3(t0, t1, t2)
| D3Etrcd1(t0, t1, t2) => tlist3(t0, t1, t2)
| D3Ebrack(t0, t1) => tlist2(t0, t1)
| D3Eif1(t0, t1, t2, t3) => tlist4(t0, t1, t2, t3)
| D3Eexist1(t0, t1) => tlist2(t0, t1)
...
| D3Etimp(d2e1, tsub1, d2c2, tsub2, t5) => tlist5(d2e1, tsub1, d2c2, tsub2, t5)
...
| D3Ecas0(knd0, d3e1, dcls) => tlist3(knd0, d3e1, dcls)
| D3Ecas1(knd0, d3e1, dcls, t4) => tlist4(knd0, d3e1, dcls, t4)
...
case+ x0 of
| T2PCASTnone() => tlist0()
| T2PCASTsome(t2p0, t2p1) => tlist2(t2p0, t2p1)
)
...
| D3Cvaldclst(knd, mopt, v3ds) => tlist3(knd, mopt, v3ds)
| D3Cvardclst(knd, mopt, v3ds) => tlist3(knd, mopt, v3ds)
| D3Cfundclst(knd, mopt, tqas, f3ds) => tlist4(knd, mopt, tqas, f3ds)
| D3Cimplmnt1(knd, mopt, sqas, tqas, id2c, ti3a, ti2s, f3as, res0, d3e0, d11) =>
  tlist11(knd, mopt, sqas, tqas, id2c, ti3a, ti2s, f3as, res0, d3e0, d11)
| D3Cimplmnt2(knd, mopt, sqas, tqas, id2c, ti3a, ti2s, f3as, res0, d3e0, d11) =>
  tlist11(knd, mopt, sqas, tqas, id2c, ti3a, ti2s, f3as, res0, d3e0, d11)
| D3Cimplmnt3(knd, mopt, sqas, tqas, id2c, ti3a, ti2s, f3as, res0, d3e0, d11) =>
  tlist11(knd, mopt, sqas, tqas, id2c, ti3a, ti2s, f3as, res0, d3e0, d11)
| D3Cnone0() => tlist0()
| D3Cnone1(d3csrc) => tlist1(d3csrc)
///
| D3Cabstype(t0, t1) => tlist2(t0, t1)
| D3Cexcptcon(t0, t1) => tlist2(t0, t1)
| D3Cdatatype(t0, t1) => tlist2(t0, t1)
...
implement{}
argsof_tag_d3fundecl(x0) = let
  val+D3FUNDECL(rcd) = x0
in
  //tlist10(rcd.loc, rcd.nam, rcd.d2c, rcd.f2g, rcd.f3g, rcd.res, rcd.def, rcd.rtp, rcd.wtp, rcd.ctp)
  tlist10(rcd.loc, rcd.nam, rcd.d2c, rcd.f2g, rcd.f3g, rcd.res, rcd.def, rcd.rtp, rcd.wtp, rcd.ctp)
end
